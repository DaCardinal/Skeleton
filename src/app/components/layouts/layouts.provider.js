(function() {
    ...
    angular
        ...
        .run(layoutRunner)
        .provider('skeletonLayout', layoutProvider);
    ...
    /* @ngInject */
    function layoutRunner($rootScope, skeletonLayout) {
        ...
        var destroyOn = $rootScope.$on('$stateChangeStart', skeletonLayout.updateLayoutFromState);
